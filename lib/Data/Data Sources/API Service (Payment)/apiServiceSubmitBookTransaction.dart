...
class SubmitBookTransactionAPIService {
  final String baseUrl = 'https://bcc.touchandsolve.com/api';
  late final String authToken;

  SubmitBookTransactionAPIService._();

  static Future<SubmitBookTransactionAPIService> create() async {
    var apiService = SubmitBookTransactionAPIService._();
  ...
  Future<Map<String, dynamic>?> submitTransaction({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/itee/payment/book'),
        headers: {
